        ...
        do {
            ...
            switch (option) {
                ...
                case 2: {
                    ...
                    instructor.setSalary(sc.nextDouble());
                    System.out.println("Materia a instruir");
                ...
                case 3: {
                    ...
                    professor.setSalary(sc.nextDouble());
                    System.out.println("Ingrese su facultad");
                    professor.setFaculty(sc.nextLine());
                    System.out.println(("Ingrese su materia a impartir"));
